...
После первого входа в админку см. подробную инструкцию: **[DIRECTUS_SETUP.md](DIRECTUS_SETUP.md)**

Кратко:
1. Создайте коллекции для контента (страницы, продукция, проекты, настройки)
2. Настройте права доступа для публичного API
3. Загрузите изображения в File Library
4. Создайте контент для сайта
